...
public class SpAtlas_Editor : Editor
{
	...
	{
		ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, ScriptableObject.CreateInstance<DoCreateAtlas>(), "New Atlas.asset", null as Texture2D, null);
	}
	...
	private void DrawBorder(SpSource source)
	{
		...
		{
			source.CustomBorder = EditorGUI.Vector4Field(rect2, null, source.CustomBorder);
		}
	}
